...
export const defaultInputs = () => ({
  companyName: 'EURL Froid Horizon',
  managerName: 'Arnaud Petit',
  mainClient: 'Frigo Est',
  ...
  return {
    ...
    entries: [
      defaultBookkeepingEntry({
        date: `${month}-03`,
        type: 'income',
        label: 'Contrat Frigo Est',
        amount: 16500,
        category: 'Recettes transport',
        status: 'payé'
      }),
      defaultBookkeepingEntry({
        date: `${month}-05`,
        type: 'expense',
        label: 'Gasoil et AdBlue',
        amount: 2400,
        category: 'Carburant',
        status: 'payé'
      }),
