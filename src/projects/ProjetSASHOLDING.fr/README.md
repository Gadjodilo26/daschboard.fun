...
Simulateur statique (HTML/ESM) destiné à produire un business plan complet pour n’importe quel projet entrepreneurial : simulation mensuelle, projection à 3 ans, besoins de financement et synthèse prête à être imprimée.
...
- **Simulation** : modifier des hypothèses clés (CA journalier, charges variables, prêt) et vérifier la mise à jour instantanée des tableaux.
...
Projet interne Atelier Entreprendre — usage privé. Ajouter une licence si diffusion prévue.
